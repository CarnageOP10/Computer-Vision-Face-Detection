...
class FaceMeshDetector():
    def __init__(self, staticMode=False,
        ...
        self.minDetectionCo=minDetectionCo
        self.minTrackingCo=minTrackingCo

        self.mpDraw = mp.solutions.drawing_utils
        self.mpFaceMesh = mp.solutions.face_mesh
        self.faceMesh = self.mpFaceMesh.FaceMesh(self.staticMode,self.maxFaces,self.refine_landmarks,self.minDetectionCo,self.minTrackingCo)
...
def main():
    cap = cv2.VideoCapture("C:\\PoseVideos\\fs.mp4")
    pTime = 0
